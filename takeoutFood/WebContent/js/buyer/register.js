...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url : "/takeoutFood/BuyerServlet",// 要请求的servlet
		data : {
...
function validatePhone() {
	...
	if (value.length != 11) {
		 ...
		 * 获取对应的label 添加错误信息 显示label
		 */
		$("#" + id + "Error").text("手机长度必须11位");
		showError($("#" + id + "Error"));
		false;
	}
	/*
	 * 3. 数字及有效号码校验 ^1(3|4|5|7|8)\d{9}$
	 */
...
function _hyz() {
	...
	$("#imgVerifyCode").attr("src",
			"/takeoutFood/VerifyCodeServlet?a=" + new Date().getTime());
}
