...
<html>
  ...
  <div class="bigBox">
    ...
    <form class="form" action="<c:url value='/admin/AdminCategoryServlet'/>" method="post" onsubmit="return checkForm()">
    	...
    	<div class="nameDiv">分类名称：<input type="text" name="cname" value="${child.cname }" id="cname"/></div>
    	...
    	<div class="descDiv">分类描述：<textarea rows="5" cols="50" name="desc" id="desc">${child.desc }</textarea></div>
    	<input type="submit" value="修改二级分类"  class="subtn"/>
